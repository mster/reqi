  ...
  request (options, requestBody = null) {
    ...
    const requestPromise = new Promise((resolve, reject) => {
      ...
      function attemptRetry (retryAfter) {
        if (retryAfter) {
          debug('retrying request after wait period')
      ...
      debug('making request', requestOptions)
      ...
      req.on('response', (res) => {
        ...
        res.once('end', function responseEnded () {
          ...
          if (typeof self.clientOptions.retryCodes === 'number') {
            const formattedCodes = [self.clientOptions.retryCodes]
            self.clientOptions.retryCodes = formattedCodes
          }
